...
import { Dumbbell, Users, Calendar, BarChart3, CheckCircle, ArrowRight } from 'lucide-react';
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div className="max-w-lg">
                ...
                <p className="text-white/80 text-lg mb-6">
                  Join thousands of gym owners and managers who have streamlined their operations with ZIM.
                </p>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={idx} className="flex items-center">
                    <CheckCircle className="h-6 w-6 text-accent-300 mr-2" />
